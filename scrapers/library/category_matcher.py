...
def categorize_by_keywords(title):
    ...
    categories = {
        'Arts & Culture': [
            ...
            'VISUAL', 'STUDIO', 'ARTISAN', 'HANDMADE', 'SHOW', 'STITCH', 'PAINT'
        ],
        ...
        'Education & Workshops': [
            'EDUCATION', 'WORKSHOP', 'LEARNING', 'SOCRATES', 'LEARN', 'BEEKEEPING', 'CAFE'
        ],
        ...
        'Games': [
            'PUZZLE', 'CHESS', 'GAMES', 'TRIVIA', 'BINGO', 'MAHJONG'
        ],

        'Health & Wellness': [
            'HEALTH', 'WELLNESS', 'MEDITATION', 'SELF-HEALING'
        ],
        ...
        'Health & Wellness': [
            'YOGA', 'T’AI CHI', 'QIGONG', 'MEDITATION'
        ]
    ...
    matched_categories = []
    # print('matching title:', title_words)
