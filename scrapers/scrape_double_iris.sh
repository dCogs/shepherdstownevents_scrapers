...
PROGRAM_DIR="/Users/dan/shepherdstownevents/scrapers/double_iris"
...
python double_iris_extractor.py

# Store the current date in a variable
today_date=$(date +"%Y%m%d")

cp "double_iris_${today_date}.ics" "../scraped_files/double_iris.ics" 
